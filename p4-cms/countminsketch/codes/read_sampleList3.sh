...
echo "register_read sampleList_src" | $CLI_PATH heavy_hitter.json 22224
echo
echo "displaying register2"
echo "register_read sampleList_dst" | $CLI_PATH heavy_hitter.json 22224
echo
echo "displaying register3"
echo "register_read sampleList_count" | $CLI_PATH heavy_hitter.json 22224
echo
