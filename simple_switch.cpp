...
struct xxhash64_1{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 1);
}
};

struct xxhash64_2{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 2);
}
};
struct xxhash64_3{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 3);
}
};

struct xxhash64_4{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 4);
}
};

struct xxhash64_5{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 5);
}
};
struct xxhash64_6{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 6);
}
};

struct xxhash64_7{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 7);
}
};

struct xxhash64_8{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 8);
}
};
struct xxhash64_9{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 9);
}
};

struct xxhash64_10{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 10);
}
};

struct xxhash64_11{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 11);
}
};
struct xxhash64_12{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 12);
}
};

struct xxhash64_13{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 13);
}
};

struct xxhash64_14{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 14);
}
};
struct xxhash64_15{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 15);
}
};

struct xxhash64_16{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 16);
}
};

struct xxhash64_17{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 17);
}
};
struct xxhash64_18{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 18);
}
};

struct xxhash64_19{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 19);
}
};

struct xxhash64_20{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 20);
}
};
struct xxhash64_21{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 21);
}
};

struct xxhash64_22{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 22);
}
};

struct xxhash64_23{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 23);
}
};

struct xxhash64_24{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 24);
}
};
struct xxhash64_25{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 25);
}
};

struct xxhash64_26{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 26);
}
};

struct xxhash64_27{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 27);
}
};
struct xxhash64_28{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 28);
}
};

struct xxhash64_29{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 29);
}
};
...
struct xxhash64_30{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 30);
}
};
struct xxhash64_31{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 31);
}
};

struct xxhash64_32{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 32);
}
};

struct xxhash64_33{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 33);
}
};

struct xxhash64_34{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 34);
}
};
struct xxhash64_35{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 35);
}
};

struct xxhash64_36{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 36);
}
};

struct xxhash64_37{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 37);
}
};
struct xxhash64_38{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 38);
}
};

struct xxhash64_39{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 39);
}
};

struct xxhash64_40{
    uint64_t operator()(const char *buf, size_t s) const {
        return bm::hash::xxh64_seed(buf, s, 40);
}
};
}  // namespace
...
REGISTER_HASH(xxhash64_1);
REGISTER_HASH(xxhash64_2);
REGISTER_HASH(xxhash64_3);
REGISTER_HASH(xxhash64_4);
REGISTER_HASH(xxhash64_5);
REGISTER_HASH(xxhash64_6);
REGISTER_HASH(xxhash64_7);
REGISTER_HASH(xxhash64_8);
REGISTER_HASH(xxhash64_9);
REGISTER_HASH(xxhash64_10);
REGISTER_HASH(xxhash64_11);
REGISTER_HASH(xxhash64_12);
REGISTER_HASH(xxhash64_13);
REGISTER_HASH(xxhash64_14);
REGISTER_HASH(xxhash64_15);
REGISTER_HASH(xxhash64_16);
REGISTER_HASH(xxhash64_17);
REGISTER_HASH(xxhash64_18);
REGISTER_HASH(xxhash64_19);
REGISTER_HASH(xxhash64_20);
REGISTER_HASH(xxhash64_21);
REGISTER_HASH(xxhash64_22);
REGISTER_HASH(xxhash64_23);
REGISTER_HASH(xxhash64_24);
REGISTER_HASH(xxhash64_25);
REGISTER_HASH(xxhash64_26);
REGISTER_HASH(xxhash64_27);
REGISTER_HASH(xxhash64_28);
REGISTER_HASH(xxhash64_29);
REGISTER_HASH(xxhash64_30);
REGISTER_HASH(xxhash64_31);
REGISTER_HASH(xxhash64_32);
REGISTER_HASH(xxhash64_33);
REGISTER_HASH(xxhash64_34);
REGISTER_HASH(xxhash64_35);
REGISTER_HASH(xxhash64_36);
REGISTER_HASH(xxhash64_37);
REGISTER_HASH(xxhash64_38);
REGISTER_HASH(xxhash64_39);
REGISTER_HASH(xxhash64_40);
